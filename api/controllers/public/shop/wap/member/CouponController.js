...
module.exports = {
  index: function (req, res) {
    ...
    async.parallel({
      ...
      return res.view('public/shop/' + sails.config.system.ShopConfig.shop_templet + '/wap/member_coupon', req.data);
  ...
  list: function (req, res) {
    ...
    Shop_member_coupon.getPageList(pageSize, start, where, sort, function (obj) {
