...
module.exports = {
  index: function (req, res) {
    ...
    async.parallel({
      ...
      req.data.id = id;
      return res.view('public/shop/' + sails.config.system.ShopConfig.shop_templet + '/wap/hot', req.data);
    });
  },
  ajax: function (req, res) {
    ...
    Shop_goods.getPageList(sails.config.system.ShopConfig.list_page_size || 8, start, {
      disabled: false
    }, sort, function (obj) {
      return res.json(obj);
    });
