...
Alipay.prototype.trade_create_by_buyer_return = function(req, cb){
  var self = this;
...
Alipay.prototype.trade_create_by_buyer_notify = function(req, cb){
  var self = this;
...
Alipay.prototype.refund_fastpay_by_platform_pwd_notify = function(req, cb){
  var self = this;
...
Alipay.prototype.create_partner_trade_by_buyer_return = function(req, cb){
  var self = this;
...
Alipay.prototype.create_partner_trade_by_buyer_notify = function(req, cb){
  var self = this;
...
//即时到帐异步通知
Alipay.prototype.create_direct_pay_by_user_notify = function(req, cb){
  var self = this;
...
//即时到帐跳转通知
Alipay.prototype.create_direct_pay_by_user_return = function(req, cb){
  var _GET = req.query;
  //计算得出通知验证结果
  var alipayNotify = new AlipayNotify(this.alipay_config);
  alipayNotify.verifyReturn(_GET, function(verify_result){
